...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    TK_LIT_UINT = 294,             /* TK_LIT_UINT  */
    TK_LIT_FLOAT = 295,            /* TK_LIT_FLOAT  */
    TK_LIT_FALSE = 296,            /* TK_LIT_FALSE  */
    TK_LIT_TRUE = 297,             /* TK_LIT_TRUE  */
    TK_LIT_CHAR = 298,             /* TK_LIT_CHAR  */
    TK_LIT_STRING = 299,           /* TK_LIT_STRING  */
    TK_IDENTIFICADOR = 300,        /* TK_IDENTIFICADOR  */
